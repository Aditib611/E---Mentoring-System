    ...
    <div class="ts-main-content">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-title">Mentee Attendance</h2>
...
<?php   
$aid=$_SESSION['id'];
$ret="SELECT a.*, r.firstName, r.lastName, r.prnno, r.contactno, r.year, r.emailid FROM attendance a JOIN registration r ON a.prnno = r.prnno";
...
<a href="attendance_tracker.php?del=<?php echo $row->id;?>" title="Delete Record" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
                                        </tr>
                                    <?php
$cnt=$cnt+1;
                                     } ?>
