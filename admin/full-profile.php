			  ...
			  <td colspan="2"  class="font1"><table width="100%" border="0">
                <tr>
                  ...
                  <td width="22%" valign="top" class="heading">Semister : </td>
                    ...
                    <!-- <tr>
                    <td width="12%" valign="top" class="heading">Mentor Name : </td>
...
else
{
  echo "Regular";
                    ...
                    <td width="12%" valign="top" class="heading">Course: </td>
                       <td class="comb-value1"><?php echo $dr=$row['course'];?></td>
...
<tr>
<td width="12%" valign="top" class="heading">Frist Name: </td>
...
<?php } ?>
  ...
  <td width="35%" class="comb-value">
    <input id="printButton" name="Submit" type="submit" class="txtbox4" value="Print this Document" onClick="return f3();" />
  </td>
  <td width="26%">
    <input id="closeButton" name="Submit2" type="submit" class="txtbox4" value="Close this document" onClick="return f2();"  />
  </td>
</tr>
          <td width="8%">&nbsp;</td>
          <td width="14%">&nbsp;</td>
  ...
  <tr>
    <td colspan="2" align="center">
      <p>Designed and Developed by Omkar Shirsath and Team</p>
    </td>
  </tr>
