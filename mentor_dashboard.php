                            ...
                            <div class="panel-body bk-primary text-light">
                                <div class="stat-panel text-center">
                                   ...
                                   <?php
                                        ...
                                        // Prepare the SQL query to retrieve the count of mentees associated with the mentor
                                        $query = "SELECT COUNT(*) FROM userregistration WHERE mentor_id = ?";
                                        ...
                                        <!-- Now you can use $count to display the total number of mentees associated with the mentor -->
                                   
                                    <div class="stat-panel-number h1 "><?php echo $count; ?></div>
                                    <div class="stat-panel-title text-uppercase"> Mentees</div>
                                </div>
                            </div>
                            <a href="mentees_assigned.php" class="block-anchor panel-footer">Full Detail <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <!-- <div class="col-md-4">
                        <div class="panel panel-default">
                            <div class="panel-body bk-success text-light">
                                <div class="stat-panel text-center">
                                    <?php
                                    $result1 = "SELECT count(*) FROM mentors ";
                                    ...
                                    <div class="stat-panel-title text-uppercase">Total mentors </div>
                                </div>
                            </div>
                            <a href="manage-mentors.php" class="block-anchor panel-footer text-center">See All &nbsp; <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div> -->
                    <!-- <div class="col-md-4">
                        <div class="panel panel-default">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form action="save-event_mentor.php" method="POST">
